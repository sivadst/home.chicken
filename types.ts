...
import { AILoggerType } from "./ai/lib/ai-log-filters";
 ...
 */
export type AIClientOptions = GoogleGenAIOptions & { apiKey: string };
...
export type AILogEvent = {
  ...
  type: AILogEventType | SharedAppLogEventType;
  message: any;
  count?: number;
};
...
export type AICustomConsoleProps = {
  agentName?: string;
...
export const modelOptions = [
  { value: "gemini-3-flash-preview", label: "AI" },
  { value: "gemini-3-pro-preview", label: "Advanced AI" },
];
