...
import "./ai-custom-console.css";

import { createPartFromText } from "@google/genai";
import {
  AICustomConsoleProps,
  OverlayPosition,
  LogStyle,
  logStyleOptions,
  modelOptions,
...
function AICustomConsole({
  ...
  const [logFilter, setLogFilter] = useState<AILoggerType>(initialLogFilter);
          ...
          <div className={cn("logger-section", { disabled: !connected })}>
            ...
            {showLogger && (
              <div className="logger-container" ref={loggerRef}>
                <AILogger filter={logFilter} logStyle={logStyle} />
              </div>
            )}
          </div>
        )}
...
export default memo(AICustomConsole);
