...
import { AIClientOptions, AILogEvent, AILogEventType, SharedAppLogEventType, LogDirection } from "../../types";
...
export class GenAIClient extends EventEmitter<AIClientEventTypes> {
